...
app.get("/random", (req, res) => {
  ...
  const joke = jokes.find(item => (item.id === random));
  res.json(joke);
});
...
app.get("/jokes/:id", (req,res) => {
  ...
  const jokeFound = jokes.find(item => (item.id === id));
  res.json(jokeFound);
});
...
app.get("/filter", (req,res) => {
  ...
  const jokeList = jokes.filter(item => (item.jokeType === type));
  res.json(jokeList);
});
...
app.put("/jokes/:id", (req,res) => {
  const id = parseInt(req.params.id);
  const jokeIndex = jokes.findIndex(item => (item.id===id));
...
app.delete("/jokes/:id", (req,res) => {
    const id = parseInt(req.params.id);
    const deleteIndex = jokes.findIndex(item => (item.id === id));
